			...
			<td width="750" valign="top" align="center">
				...
				<table border="1" align="top" width=100%>
					...
					<c:forEach items="${employeeList}" var="employee">
						<tr style="border: 1px solid black; width: 100%">
							...
							<td><a href="viewEmployee?employeeId=${employee.employeeId}"><i
									class="fa fa-eye" style="color: black"></i></a></td>
							<td><a href="editEmployee?employeeId=${employee.employeeId}"><i
									class="fa fa-edit" style="color: black"></i></a></td>
							<td><a
								href="deleteEmployee?employeeId=${employee.employeeId}"><i
				...
				<h3 style="text-align: center;">
					<button style="background-color: #1c4966; color: white">
						<a href='home'
							style="text-decoration: none; background-color: #1c4966; color: white">Back
							To Home</a>
					</button>
				</h3> </c:if>
